...
--
-- Hôte : localhost:3306
-- Généré le : mer. 10 juin 2026 à 03:05
...
--
-- Structure de la table `deliverymen_realtime`
--

CREATE TABLE `deliverymen_realtime` (
  `rider_id` int(11) NOT NULL,
  `current_lat` decimal(10,8) NOT NULL,
  `current_lng` decimal(11,8) NOT NULL,
  `heading` float DEFAULT 0 COMMENT 'Direction (0-360)',
  `speed` float DEFAULT 0 COMMENT 'Vitesse km/h',
...
--
-- Structure de la table `tracking_logs`
--
...
--
-- Index pour la table `deliverymen_realtime`
--
ALTER TABLE `deliverymen_realtime`
...
--
-- Index pour la table `tracking_logs`
--
ALTER TABLE `tracking_logs`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_rider_time` (`rider_id`,`created_at`);
...
--
-- AUTO_INCREMENT pour la table `tracking_logs`
--
ALTER TABLE `tracking_logs`
...
--
-- Contraintes pour la table `deliverymen_realtime`
--
ALTER TABLE `deliverymen_realtime`
  ADD CONSTRAINT `fk_dm_realtime_user` FOREIGN KEY (`rider_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
-- Contraintes pour la table `tracking_logs`
--
ALTER TABLE `tracking_logs`
  ADD CONSTRAINT `fk_track_logs_user` FOREIGN KEY (`rider_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
