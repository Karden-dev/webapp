...
const shopProspectModel = require('./models/shop.prospect.model'); // Nouveau modèle B2B
...
// Capture le corps brut (rawBody) pour la vérification de signature
// Doit impérativement être placé AVANT les parseurs globaux
