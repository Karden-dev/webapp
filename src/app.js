...
const stockReportRoutes = require('./routes/stock.report.routes'); // <--- NOUVEAU
...
const stockReportModel = require('./models/stock.report.model'); // <--- NOUVEAU (Correction erreur Database)
...
async function startServer() {
    ...
    // Initialisation du rapporteur de stock (CRUCIAL pour l'erreur 500)
    ...
    app.use('/api/stock/reports', stockReportRoutes); // <--- La route pour le PDF
